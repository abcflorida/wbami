...
class ControllerModuleamiCommonHeader extends Controller {
	public function index() {
		...
		$data['description'] = 'Order Trackging Management system';
		$data['keywords'] = 'Airplane parts inventory management, simple inventory';
		$data['links'] = $this->document->getLinks();
		$data['styles'] = $this->document->getStyles();
		$data['scripts'] = $this->document->getScripts();
		$data['lang'] = $this->language->get('code');
		$data['direction'] = $this->language->get('direction');
                $data['heading_title'] = "AMI Work Order Management";
		...
		$data['text_logged'] = sprintf($this->language->get('text_logged'), $this->customer->getEmail());
		...
		//} else {
                ...
                $data['home'] = $this->url->link('module/ami/dashboard', 'token=' . $this->session->data['token'], 'SSL');
                $data['logout'] = $this->url->link('module/ami/common/logout', 'token=' . $this->session->data['token'], 'SSL');
		...
		//}
                ...
                //echo DIR_TEMPLATE . 'wb/template/common/header.tpl';
                return $this->load->view('/wb/template/common/header.tpl', $data);
	}
}